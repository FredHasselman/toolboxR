...
varfun.Savani.1 <- function(vars=ML2.sr){
  ...
  # sava2.10=choice (restaurant by yourself); 
 ...
 #  'sava2.4', 'sava2.5', 'sava2.9', 'sava2.10', 'sava2.15', 'sava2.16' , 'sava2.21', 'sava2.22', 'sava2.27', 'sava2.28', 'sava2.33', 'sava2.34',  'sava2.38', 'sava2.39', 'sava2.43', 'sava2.44'  
...
#   require(lme4)   
#   
#   choice.Int    <- c('sava1.4', 'sava1.9',  'sava1.10', 'sava1.15', 'sava1.21', 'sava1.27', 'sava1.33', 'sava1.34', 'sava1.38', 'sava1.43')
#   importance.Int <- c('sava1.5', 'sava1.16', 'sava1.22', 'sava1.28', 'sava1.39', 'sava1.44')
#     
#   choice.Pers   <- c('sava2.4', 'sava2.9',  'sava2.10', 'sava2.15', 'sava2.21', 'sava2.27', 'sava2.33', 'sava2.34', 'sava2.38', 'sava2.43')
#   importance.Pers <- c('sava2.5', 'sava2.16', 'sava2.22', 'sava2.28', 'sava2.39', 'sava2.44')
#   
#   
#   choice<- melt(rbind(select(vars$Interpersonal, one_of(choice.Int))))
#   
#   Condition  <- factor(c(rep(1,vars$N[1]),rep(2,vars$N[2])),levels=c(1,2),labels=vars$labels$Condition) 
#   Response   <- rbind(select(vars$Interpersonal, one_of(choice.Int)), select(vars$Interpersonal, importance = one_of(importance.Int)))
#   vars$Interpersonal <- vars$Interpersonal %>% mutate(Condition = "Interpersonal")  
#   df.ip<-melt(vars$Interpersonal)
#   
#    glmer(Response ~ Importance*Condition + (1|uID/trialD),family = binomial('logit')
# #   
#   
}
...
# zhon2.1=ethical condition; zhon.dv.1_1 TO zhon.dv.1_10=desirability of products (both conditions); higher numbers=higher desirability; # Products list: 
...
# Schwarz, N., Strack, F., & Mai, H. P. (1991). Assimilation and contrast effects in part-whole question sequences: A conversational logic analysis. Public Opinion Quarterly, 55, 3-23.	schw1.1=life sat (first); schw1.2=partner satisfaction (second); schw2.1=partner satisfaction (first); schw2.2=life sat (second). for all, higher numbers=higher satisfaction	
}
